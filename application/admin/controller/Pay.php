...
//企业付款到微信零钱，PHP接口调用方法
define("APPID", "wxc63f3326fcfff6bd"); // 商户账号appid
define("MCHID", "1372486502");      // 商户号
define("SECRECT_KEY", "636c32d25e03733be260e8eb3f91ca98");  //支付密钥签名
define("IP", "192.168.100.224");   //IP
